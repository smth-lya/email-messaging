...
**Что сделано:**
1. Полноценный провайдер с `IEmailSender`, поддерживающий одиночные, массовые и отложенные отправки
2. HTML-шаблоны на базе Razor Components с параметризацией
3. Конфигурация через `appsettings.json` с поддержкой множества шаблонов
